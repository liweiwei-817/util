...
public class MailSender {
    ...
    public MailInfo getMailInfo() {
        ...
        info.setUsername("2622026762@qq.com");
        info.setPassword("liushqzbhzhadjgc");
        info.setNotifyTo(null);
        info.setNotifyCc(null);
